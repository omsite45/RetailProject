    ...
    stages {
        ...
        stage('Deploy') {
            steps {
                ...
                // Add deployments add steps here (e.g., deploy to a server or cloud)

                // Add deployment add steps here (e.g., deploy to a a server or cloud)
                //sh 'sshpass -p $LABS_PSW scp -o StrictHostKeyChecking=no -r retailprojects.zip $LABS_USR@g02.itversity.com:/home/itv014498/retailproject2'
